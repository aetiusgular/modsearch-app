...
The ModSearch desktop client. Tauri 2.x (Rust core + webview frontend) with a single Rust sidecar
...
crates/
  sidecar/     Rust ML worker: ONNX Runtime embeddings (Marqo-FashionSigLIP, CoreML/DirectML EP),
               ...
               idle-on-AC head training. This is the mod-recs-engine port target.
...
happens in the cloud (modsearch-server). See PRD Section 6 and mod-recs-engine/ADAPTATION.md.
